...
float_T torque;
//   Envelope Parameters
const vec_T envelopeM = {pi/2.0 - pi/2.0, pi/2.0 + pi/2.0}; // The envelope in which MTs from M can grow. 
const vec_T envelopeD = {pi/2.0 - pi/6.0, pi/2.0 + pi/6.0}; // The envelope in which MTs from M can grow. 
//   Spring Parameters
const float_T kM = 8;
const float_T kD = 16;
