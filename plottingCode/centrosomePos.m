...
title('Average Centrosome Trajectories (Discrete)--No Band','FontSize', 16)
...
ylabel('Fraction Egg Length in Y');
legend('Centrosome M','Centrosome D');
title('Average Centrosome Trajectories (Lined)--No Band','FontSize', 16)
...
ylabel('Fraction Egg Length in Y');
legend('Centrosome M','Centrosome D');
title('Average Centrosome Trajectories (Discrete)--Banded','FontSize', 16)
...
ylabel('Fraction Egg Length in Y');
legend('Centrosome M','Centrosome D');
title('Average Centrosome Trajectories (Lined)--Banded','FontSize', 16)
