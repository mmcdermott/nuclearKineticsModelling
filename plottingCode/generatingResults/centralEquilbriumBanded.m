...
dataFile = 'centralEquilBanded/start10';
run parameters.m
dataFile2 = 'centralEquilBanded/start15';
dataFile3 = 'centralEquilBanded/start20';
dataFile4 = 'centralEquilBanded/start25';
...
title('Final x Position Tendencies Given Band -3pi/8 to 3pi/8','FontSize',18)
